...
class HelmTable(object):
    ...
    def eos_DT(self, den, temp, abar, zbar, outvar=None):
        ...
        fi[0] = self._ef[iat, jat]
        fi[1] = self._ef[iatp1, jat]
        fi[2] = self._ef[iat, jatp1]
        fi[3] = self._ef[iatp1, jatp1]
        fi[4] = self._eft[iat, jat]
        fi[5] = self._eft[iatp1, jat]
        fi[6] = self._eft[iat, jatp1]
        fi[7] = self._eft[iatp1, jatp1]
        fi[8] = self._efd[iat, jat]
        fi[9] = self._efd[iatp1, jat]
        fi[10] = self._efd[iat, jatp1]
        fi[11] = self._efd[iatp1, jatp1]
        fi[12] = self._efdt[iat, jat]
        fi[13] = self._efdt[iatp1, jat]
        fi[14] = self._efdt[iat, jatp1]
        fi[15] = self._efdt[iatp1, jatp1]
        ...
        fi[0] = self._xf[iat, jat]
        fi[1] = self._xf[iatp1, jat]
        fi[2] = self._xf[iat, jatp1]
        fi[3] = self._xf[iatp1, jatp1]
        fi[4] = self._xft[iat, jat]
        fi[5] = self._xft[iatp1, jat]
        fi[6] = self._xft[iat, jatp1]
        fi[7] = self._xft[iatp1, jatp1]
        fi[8] = self._xfd[iat, jat]
        fi[9] = self._xfd[iatp1, jat]
        fi[10] = self._xfd[iat, jatp1]
        fi[11] = self._xfd[iatp1, jatp1]
        fi[12] = self._xfdt[iat, jat]
        fi[13] = self._xfdt[iatp1, jat]
        fi[14] = self._xfdt[iat, jatp1]
        fi[15] = self._xfdt[iatp1, jatp1]
